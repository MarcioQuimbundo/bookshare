...
class _HomePageState extends State<HomePage>
  ...
  final List<String> _categories =
      ['Matemática', 'Geografia', 'Química',
        'Física', 'Romance', 'Programação'];
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index){
          return _BookListItem(data: index,);
        },
      ),
    );
  }
...
class _BookListItem extends StatefulWidget {
  ...
  const _BookListItem({Key key, this.data}) : super(key: key);

  @override
  __BookListItemState createState() => __BookListItemState();
}

String url = "https://bayareaanarchistbookfair.com/wp-content/uploads/2017/02/Bookfair2017_poster.jpg";
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          IconButton(
            icon: Icon(wasStarred ? Icons.favorite : Icons.favorite_border,
